...
Let me be clear about one thing, because I don't want anyone to read this as "avoid treatment." For many people, these medications are genuinely life-changing, and intolerance to one blunt tool does not close the door. There are **more selective** options worth raising with a specialist. **[Lacosamide](https://prrt2.org/treatments/medications/lacosamide)**, for instance, acts on the *slow* inactivation of sodium channels — it preferentially quiets the rapid burst-firing that drives episodes while leaving ordinary firing more intact. **Eslicarbazepine** and **lamotrigine** are other, cleaner-profile members of the broad family; **acetazolamide**, which isn't a sodium-channel drug at all, sometimes helps the exertional and atypical presentations. (See [Medications](https://prrt2.org/treatments/medications) — which, if any, fits a given person is entirely a specialist's call.)
...
_Have you faced this trade-off between control and clarity? Your experience is part of the case we're making. Share it through our community — see [Links & Support](https://prrt2.org/resources/links-and-support) — or read others' on [Patient Stories](https://prrt2.org/living/patient-stories)._

## Continue reading

* [How Treatment Works for PRRT2](https://prrt2.org/treatments/how-treatment-works) — the current landscape
* [Carbamazepine](https://prrt2.org/treatments/medications/carbamazepine) — the established first-line drug, in full
* [Future Therapeutics](https://prrt2.org/research/future-therapeutics) — the case for targeted treatment
